    ...
    <>
      ...
      >
        <div class="h-full px-3 py-4 overflow-y-auto bg-white dark:bg-gray-800">
          {/* Logo */}
          <div className="m-5 ml-0 h-10 w-10 rounded-lg bg-[#5864E8]"></div>

          <ul class="space-y-2 font-medium">
            <li>
              <button class="flex items-center p-2 text-white rounded-lg bg-[#5864E8] dark:text-white hover:bg-gray-100 hover:text-gray-900 dark:hover:bg-gray-700 group">
                <svg
